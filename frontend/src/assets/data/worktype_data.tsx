...
const RetireReasonPopup02 = () => {
  return (
    <div className="string_popup txt_ct fs_16 lh_24">
...
export const retire_reason_standard_popup = [
  <RetireReasonPopup01 />,
  <RetireReasonPopup02 />,
  <RetireReasonPopup03 />,
  <RetireReasonPopup04 />,
...
export const retire_reason_art_popup = [
  <RetireReasonPopup01 />,
  <RetireReasonPopup06 />,
  <RetireReasonPopup02 />,
  <RetireReasonPopup03 />,
...
export const retire_reason_dayjob_popup = [
  <RetireReasonPopup01 />,
  <RetireReasonPopup06 />,
  <RetireReasonPopup02 />,
  <RetireReasonPopup03 />,
